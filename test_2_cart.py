...
def test_remove_from_cart(browser, standard_auth):
    ...
    cart_remove_btns = browser.find_elements(*cart_remove_btn)
...
def test_remove_item_from_item_card(browser, standard_auth):
    ...
    cart_tag_before4 = browser.find_element(*cart_tag).text
    ...
    # click remove button:
    browser.find_element(*card_remove_btn).click()

    # check the button changed:
    btn_txt4 = browser.find_element(*card_add_btn).text
